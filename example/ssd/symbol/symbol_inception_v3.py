...
def get_symbol_train(num_classes=20):
    ...
    # ====== ssd extra layers ======
    conv8_1, relu8_1 = conv_act_layer(in5b, "8_1", 256, kernel=(1, 1), pad=(0, 0), stride=(1, 1), act_type="relu", use_batchnorm=False)
    ...
    from_layers = [in3d, in4e, relu8_2, relu9_2, relu10_2, pool10]  # relu4_3, relu7,
    ...
    normalizations = [20, 20, -1, -1, -1, -1]  # [20, -1, -1, -1, -1, -1]
